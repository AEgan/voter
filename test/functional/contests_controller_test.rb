...
class ContestsControllerTest < ActionController::TestCase
  ...
  test "should create contest" do
    assert_difference('Contest.count') do
      post :create, contest: { description: @contest.description, name: @contest.name, user_id: @contest.user_id }
    end
  ...
  test "should update contest" do
    put :update, id: @contest, contest: { description: @contest.description, name: @contest.name, user_id: @contest.user_id }
    assert_redirected_to contest_path(assigns(:contest))
  end
